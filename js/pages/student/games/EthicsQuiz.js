...
const ETHICS_SCENARIOS = [
    ...
    },
    {
        ...
        choices: [
            {
                id: 'A', label: 'ขอ AI Scaffolding (คำใบ้) ทีละขั้น เพื่อไกด์ทิศทาง แล้วยังคิดเองต่อ',
                type: 'ethical', score: 30,
                feedback: 'สุดยอด! คำใบ้ไล่ระดับแบบโสเครติส 4 ระดับ ทำให้คุณยังต้องคิดอยู่ เหมือนครูถามคำถามนำ ไม่ใช่บอกคำตอบ',
            },
            {
