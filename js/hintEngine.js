...
function buildLocalHint(level, d, ctx) {
    ...
    if (!d) {
        ...
        return [
            ...
            '🗺 ลองกด "ทดสอบตัวอย่าง" หรือส่งงานก่อน ระบบจะวิเคราะห์ผลการทดสอบเพื่อให้ AI Scaffolding (คำใบ้) ที่ตรงจุดกว่านี้',
            '🔍 ยังไม่มีผลการทดสอบให้วิเคราะห์ — ส่งงานก่อน แล้วขอ AI Scaffolding (คำใบ้) ระดับนี้อีกครั้ง',
    ...
    if (level === 2) return `${summary}\n\n${cat.c}\n\n💭 นำความรู้นี้ไปตรวจโค้ดของคุณเอง ถ้ายังไม่เจอ ขอ AI Scaffolding (คำใบ้) ระดับ 3`;
